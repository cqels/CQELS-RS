...
> **Latest release:** [`2.0.0-alpha.20`](https://github.com/cqels/CQELS-RS/releases/tag/v2.0.0-alpha.20) · **License:** MIT · **Requires:** Rust 1.85+
>
...
```toml
[dependencies]
cqels-model = "2.0.0-alpha.20"
cqels-core = "2.0.0-alpha.20"
cqels-engine = "2.0.0-alpha.20"
cqels-reasoning = "2.0.0-alpha.20"
