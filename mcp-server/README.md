...
[`2.0.0-alpha.16`](https://github.com/cqels/CQELS-RS/releases/tag/v2.0.0-alpha.16).
...
```bash
tar -xzf cqels-mcp-2.0.0-alpha.16-<target>.tar.gz
./cqels-mcp
```
...
The alpha.16 server exposes CQELS-QL stream queries, CEP, reasoning, SHACL,
