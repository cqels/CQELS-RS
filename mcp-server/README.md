...
[`2.0.0-alpha.18`](https://github.com/cqels/CQELS-RS/releases/tag/v2.0.0-alpha.18).
...
```bash
tar -xzf cqels-mcp-2.0.0-alpha.18-<target>.tar.gz
./cqels-mcp
```
...
The alpha.18 server exposes CQELS-QL stream queries, CEP, reasoning, SHACL,
