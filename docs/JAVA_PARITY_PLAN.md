...
- [!] **Deferred (3a-layer-5d, 5f):** `WindowedJoinAggregateOperator` Reactor envelope (Layer 5d) and `delete_range` for full-tuple TimeIndex (Layer 5f). ~700 Java lines remaining.
