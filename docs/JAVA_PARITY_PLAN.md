...
- [!] **Deferred (3a-layer-5d+):** `delete_range` (Java itself notes this needs full-tuple TimeIndex), `WindowedJoinAggregateOperator` Reactor envelope, and `ParallelJoinAggregator` Tier-2 batch recompute. ~1K Java lines remaining.
